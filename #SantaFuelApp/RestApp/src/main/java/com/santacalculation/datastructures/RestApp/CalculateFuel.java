...
//    @RequestMapping("/")
//    public static double final_result() {
//
//        double[] fuel = new double[]{
...
//            fuel_calculated[i] = CalculateMass(fuel[i]);
//        }
...
//    }
    ...
    @RequestMapping("/") 
    public static double final_result_test_params(double[] fuel) {
        int n = fuel.length;
        double[] fuel_calculated = new double[n];
